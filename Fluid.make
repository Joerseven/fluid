...
ifeq ($(config),debug)
  ...
  TARGET = $(TARGETDIR)/Fluid
  OBJDIR = obj/Debug
  DEFINES += -DDEBUG
  INCLUDES += -Iexternal/raylib/include -Isrc
  FORCE_INCLUDE +=
  ...
  LIBS += -lraylib
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -Lexternal/raylib/lib -rpath @executable_path/../../external/raylib/lib
...
$(OBJDIR)/solver.o: src/solver.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
